...
$(function() {
    ...
    connection.on("ReceiveChatMessage", (msg) => {
        $("#messagesList").append(`<div style="margin-bottom: 5px;"><span style="color: #dc3545; font-weight: bold;">${escapeHtml(msg.user)}</span> <span style="color: #888888;">[${msg.time}]</span>: <span style="color: #ffffff;">${escapeHtml(msg.text)}</span></div>`);
